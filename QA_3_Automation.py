...
# File paths
file_path_1 = r'Z:\Roster_QA_3_persons_raw_data.txt'
file_path_2 = r'C:\Users\psingh\Documents\Comscore Documents\Investigation\Automation\Roster_3.2_excluding_THP.xlsx'
file_path_3 = r'Z:\Roster_QA_1_raw_data.txt'

# Add a sidebar for file selection
...
if selected_file == "QA_3.2":
    df = pd.read_csv(file_path_1, delimiter='\t')  # Assuming the file is tab-delimited
    ...
    df = pd.read_csv(file_path_3, delimiter='\t')  # Assuming the file is tab-delimited
